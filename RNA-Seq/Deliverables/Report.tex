...
Figures were created with \texttt{R} \cite{R}, RStudio \cite{RStudio}, \texttt{ggplot2} \cite{ggplot2}, \texttt{ggh4x} \cite{ggh4x}, \texttt{jsonlite} \cite{jsonlite}, \texttt{stringr} \cite{stringr}, \texttt{rstudioapi} \cite{rstudioapi}, and \texttt{Hotelling} \cite{Hotelling}.
